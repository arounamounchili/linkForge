...
class TestIMUInfo:
    ...
    def test_default_imu(self):
        ...
        imu = IMUInfo()
        assert imu.gravity_magnitude == pytest.approx(9.80665)
        assert imu.angular_velocity_frame == "child_frame"
        assert imu.linear_acceleration_frame == "child_frame"
...
class TestSensor:
    ...
    def test_camera_sensor(self):
        ...
        assert sensor.is_camera
        assert not sensor.is_lidar
    ...
    def test_lidar_sensor(self):
        ...
        assert sensor.is_lidar
        assert not sensor.is_camera
